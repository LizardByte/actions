...
| [buffer_post](actions/buffer_post#readme)             | Publish an immediate social media post through Buffer                           | composite | bash             |
| [cloudsmith_upload](actions/cloudsmith_upload#readme) | Publish DEB and RPM packages to distro-specific Cloudsmith repositories         | composite | javascript       |
